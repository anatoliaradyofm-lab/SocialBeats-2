...
const createStyles = (colors) => StyleSheet.create({
  ...
  modalOverlay: { flex: 1, backgroundColor: 'rgba(8,6,15,0.88)', justifyContent: 'center', alignItems: 'center', padding: 24 },
  modalContent: { backgroundColor: '#08060F', borderRadius: 24, borderWidth: 1, borderColor: 'rgba(192,132,252,0.18)', padding: 24, width: '100%', maxWidth: 340 },
